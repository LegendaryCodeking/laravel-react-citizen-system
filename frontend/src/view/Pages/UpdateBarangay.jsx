                ...
                <form action="">
                    ...
                    <img src={selectedImage ? selectedImage : barangayData.logoImage} className='w-20 h-20 rounded-full' alt="" />
                        ...
                        <div className='w-[500px] flex items-center justify-center gap-5 mt-4'>
                            <div className={(logoError || errors.logoImage ? 'border border-2 border-red-500' : '') + ' bg-white h-10 p-5 rounded shadow-sm flex items-center'}>
                    ...
                    <div className='mt-5'>
                        ...
                        <div className='flex items-center justify-between'> 
                            ...
                            <div className='flex items-center justify-center gap-5'>
                                {!loading && <button onClick={storeBarangay} className={(loading ? 'bg-blue-200 cursor-not-allowed' : 'bg-blue-700') + ' w-[100px]  p-2 rounded text-white text-m font-semibold'}>Submit</button>}
                                {loading && <button onClick={storeBarangay} className={(loading ? 'bg-blue-200' : 'bg-blue-700') + ' w-[100px]  p-2 rounded text-white text-m font-semibold'}>Please Wait</button>}
                            </div>
                        </div>
                    </div>
                </form>
